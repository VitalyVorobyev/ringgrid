...
|----|--------|----------|------|-------|------|-------|
| PERF-004 | in-progress | P1 | perf | Optimize outer-fit/outer-estimate hotspot group | Performance Engineer + Algorithm Engineer | Candidate #2 from PERF-001 baseline; prioritize radial/profile temp allocations and per-candidate sorting overhead under mapper and non-mapper flows |
