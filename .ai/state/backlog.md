...
|----|--------|----------|------|-------|------|-------|
| INFRA-005 | in-progress | P2 | infra | Harden BoardLayout invariants and loading errors | Pipeline Architect | Spec: `.ai/state/sessions/2026-02-19-INFRA-005-spec.md`; dispatch: `.ai/state/sessions/2026-02-19-INFRA-005-lead-pipeline-architect.md` |
