...
use super::codebook::{CODEBOOK, CODEBOOK_BITS, CODEBOOK_MIN_CYCLIC_DIST, CODEBOOK_N};
...
impl Codebook {
    ...
    pub fn match_word(&self, obs: u16) -> Match {
        ...
        let conf_margin = (margin as f32 / CODEBOOK_MIN_CYCLIC_DIST as f32).clamp(0.0, 1.0);
