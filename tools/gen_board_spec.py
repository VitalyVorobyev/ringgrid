...
The target schema is `ringgrid.target.v1` and stores board geometry as
...
TARGET_SCHEMA = "ringgrid.target.v1"
...
def main() -> None:
    ...
    parser.add_argument("--origin_x_mm", type=float, default=0.0)
    parser.add_argument("--origin_y_mm", type=float, default=0.0)
    ...
    spec = {
        ...
        "origin_mm": [float(args.origin_x_mm), float(args.origin_y_mm)],
        "board_size_mm": [float(args.board_mm), float(args.board_mm)],
